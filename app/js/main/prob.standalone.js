        ...
        function($rootScope, $scope, bmsModalService, $location, bmsSocketService, $q, bmsConfigService, ws, electronWindow) {
          ...
          var startServer = function(connected, configData) {
            ...
            if (!connected) {
              ...
              var separator = isWin ? ';' : ':';
              var server = exec('java -Xmx1024m -cp ' + appPath + '/libs/*' + separator + appPath + '/libs/bmotion-prob-0.2.6.jar -Dprob.home=' + probBinary + ' de.bms.prob.Standalone -standalone -local');
