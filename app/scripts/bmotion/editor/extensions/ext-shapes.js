...
methodDraw.addExtension("shapes", function() {
	...
	function loadLibrary(cat_id) {
		...
		if(!lib) {
			...
			$.getJSON('/bms/libs/bmseditor/extensions/shapelib/' + cat_id + '.json', function(result, textStatus) {
	...
	return {
		svgicons: "/bms/libs/bmseditor/extensions/ext-shapes.xml",
		buttons: [{
			id: "tool_shapelib",
			type: "mode_flyout", // _flyout
			position: 6,
			title: "Shape library",
			icon: "/bms/libs/bmseditor/extensions/ext-shapes.png",
			events: {
				"click": function() {
