...
methodDraw.addExtension("server_opensave", {
	callback: function() {
	  ...
	  //
		...
		var open_svg_action = '/bms/libs/bmseditor/extensions/fileopen.php?type=load_svg';
		var import_svg_action = '/bms/libs/bmseditor/extensions/fileopen.php?type=import_svg';
		var import_img_action = '/bms/libs/bmseditor/extensions/fileopen.php?type=import_img';
